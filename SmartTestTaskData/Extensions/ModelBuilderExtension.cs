...
namespace SmartTestTaskData.Extensions
{
    public static class ModelBuilderExtension
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TypeOfEquipment>().HasData(typeOfEquipment);
            modelBuilder.Entity<ProductionPremises>().HasData(productionPremises);
            modelBuilder.Entity<EquipmentPlacementContract>().HasData(equipmentPlacementContracts);
        }
    }
}
